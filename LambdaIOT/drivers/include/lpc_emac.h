/**********************************************************************
* $Id: lpc_emac.h,v 1.10 2014/01/20 02:30:50 cvsuser Exp $      lpc_emac.h          2011-06-02
*//**
* @file     lpc_emac.h
...
#define EMAC_NUM_RX_FRAG         5           /**< Num.of RX Fragments 5*1536= 7680B */
#define EMAC_NUM_TX_FRAG         5           /**< Num.of TX Fragments 5*1536= 7680B */
#define EMAC_ETH_MAX_FLEN        1536        /**< Max. Ethernet Frame Size          */
#define EMAC_TX_FRAME_TOUT       0x00100000  /**< Frame Transmit timeout count      */

/* EMAC variables located in 16K Ethernet SRAM */
#define RX_DESC_BASE        LPC_PERI_RAM_BASE                    //5*8=40
#define RX_STAT_BASE        (RX_DESC_BASE + EMAC_NUM_RX_FRAG*8)  //5*8=40
#define TX_DESC_BASE        (RX_STAT_BASE + EMAC_NUM_RX_FRAG*8)  //5*8=40
#define TX_STAT_BASE        (TX_DESC_BASE + EMAC_NUM_TX_FRAG*8)  //5*4=20
#define RX_BUF_BASE         (TX_STAT_BASE + EMAC_NUM_TX_FRAG*4)  //5*1536=7680
#define TX_BUF_BASE         (RX_BUF_BASE  + EMAC_NUM_RX_FRAG*EMAC_ETH_MAX_FLEN) //5*1536=7680, total=40+40+40+20+7680+7680=15500
...
extern EMAC_CFG_Type EMAC_Configs;
