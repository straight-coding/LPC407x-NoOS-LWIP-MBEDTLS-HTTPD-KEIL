/**********************************************************************
* $Id: lpc_gpio.h,v 1.4 2013/12/30 05:14:10 cvsuser Exp $      lpc_gpio.h          2011-06-02
*//**
* @file     lpc_gpio.h
...
#define PIN_SET(port,attr) 			(port->SET = 1<<((attr>>1)&0x7f))
#define PIN_CLR(port,attr) 			(port->CLR = 1<<((attr>>1)&0x7f))
#define PORT_GET(port) 				(port->PIN)
...
__inline void PIN_TOG(LPC_GPIO_TypeDef* port,uint32_t attr) 			
{
	...
	port->SET = ~pin_reg&(1<<((attr>>1)&0x7f));
