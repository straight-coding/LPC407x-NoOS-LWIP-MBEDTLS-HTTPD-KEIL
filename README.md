...
* `Certificate Tool`: used to generate the pem file named `lwip_cert.c`. (产生 PEM 格式的自签服务器证书)
...
* The easiest way is to use [`EmbedTools`](https://github.com/straight-coding/EmbedTools) to generate file `httpd/fs_data.c`.
